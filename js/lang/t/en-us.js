window.kazImageCraftLang = {
    duplicate: filename => `File "${file.name}" has already been uploaded. Do you want to continue uploading it again?`,
    ...
    rotateConfirm: '✔️',
    rotateCancel: '✖️',
    resetWarning: '⚠️ This will overwrite your edited image and restore it to the original.',
